...
import com.akanbi.rickandmorty.presentation.screen.character.CharacterDetailsScreen
import com.akanbi.rickandmorty.presentation.screen.character.CharacterScreen
import com.akanbi.rickandmorty.presentation.screen.splash.SplashScreenComponent
import com.akanbi.rickandmorty.presentation.screen.splash.SplashScreenViewModel
    ...
    private fun BuildNavHost(navController: NavHostController) {
        NavHost(
            ...
            composable(route = CharacterDestination.route) {
                ...
                SetupCharacterScreen(navController, characterViewModel)
            }
